        ...
        child: SingleChildScrollView(
          child: Padding(
            ...
            child: Column(
              children: [
                SizedBox(height: 30),
                Text('Welcome Back!', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 24, color: Colors.purple[700])),
                SizedBox(height: 8),
                Text('Log in to continue your ADHD journey', style: TextStyle(color: Colors.grey[700])),
                SizedBox(height: 22),
                Container(
